...
void  appointmentNotification_protocol_API_(struct SAppointment ap,  int wp); //deliver the appointment message to user process.
//struct SAppointment  appointmentNotification_protocol_childAPI(int rp);
