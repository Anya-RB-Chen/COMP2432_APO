...
//(4) appointment
int g_apNum = 0;
struct SAppointment *g_appointmentArray = NULL;  //assumption: not exceed the capacity
...
//    g_endTime =  ;
    ...
    g_appointmentArray = (struct SAppointment*) (malloc(sizeof(struct SAppointment) * DEFAULT_CAPACITY_OF_VECTOR + 1));
